...
class ReplayBuffer(object):
    ...
    def _encode_sample(self, idxes):
        ...
        #hid_batch = self.hid[idxes]

        return obs_batch, act_batch, rew_batch, next_obs_batch, done_mask #, hid_batch
    ...
    #def store_frame(self, frame, hid_shape):
        ...
        if self.obs is None:
            ...
            #self.hid     = np.empty([self.size, hid_shape],                     dtype=np.float32)
    ...
    #def store_effect(self, idx, action, reward, done, hid):
